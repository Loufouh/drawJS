 ...
 */
export function resetTransform(ctx = targetContext) {
    setTransform(
        1,
        0,
        0,
 ...
 * @param ctx The canvas' context.
 */
export function setTransform(horizontalScaling, horizontalSkewing, verticalSkewing, verticalScaling, horizontalTranslation, verticalTranslation, ctx = targetContext) {
    ctx.setTransform(
        horizontalScaling,
        horizontalSkewing,
        verticalSkewing,
 ...
 * @param ctx The canvas' context.
 */
export function translate(x, y, ctx = targetContext) {
    ctx.translate(x, y);
}
 ...
 * @param ctx The canvas' context.
 */
export function rotate(angle, ctx = targetContext) {
    ctx.rotate(angle);
}
 ...
 * @param ctx The canvas' context.
 */
export function scale(x, y, ctx = targetContext) {
    ctx.scale(x, y);
}
 ...
 * @param ctx The canvas' context.
 */
export function save(ctx = targetContext) {
    ctx.save();
}
 ...
 * @param ctx The canvas' context.
 */
export function restore(ctx = targetContext) {
    ctx.restore();
}
