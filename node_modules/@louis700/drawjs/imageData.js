 ...
 */
export function foreachImageData(imgData, func, use2DCoordinates = true) {
 ...
 */
export function mapImageData(imgData, func, use2DCoordinates = true) {
 ...
 * @param posX The x coordinate of the region (based on the upper left corner).
 * @param posY The y coordinate of the region (based on the upper left corner).
 ...
 * @param use2DCoordinates True if the function needs x and y, false if it needs pixel's index.
 */
export function foreachImageDataRect(posX, posY, width, height, imgData, func, use2DCoordinates = true) {
    mapImageDataRect(
        posX,
        posY,
        width,
 ...
 * @returns {*} The new image's data.
 */
export function mapImageDataRect(posX, posY, width, height, imgData, func, use2DCoordinates = true) {
    if (
 ...
 */
export function getPixel(x, y, imgData) {
 ...
 */
export function setPixel(x, y, imgData, color) {
 ...
 * @param color The pixel to set (as a Color object).
 */
export function setPixelByIndex(i, imgData, color) {
 ...
 */
export function getPixelByIndex(i, imgData) {
    return new Color(
        imgData.data[i * 4],
        imgData.data[i * 4 + 1],
        imgData.data[i * 4 + 2],
 ...
 */
export function getPixelIndex(x, y, imgData) {
 ...
 */
export function createImageData(width, height, ctx = targetContext) {
    return ctx.createImageData(width, height, ctx);
}

/**
 * Get the image's data of the region of the canvas.
 * @param x The x coordinate of the region (based on the upper left corner).
 * @param y The y coordinate of the region (based on the upper left corner).
 * @param width The width of the region.
 * @param height The height of the region.
 * @param ctx The canvas' context.
 * @returns {ImageData} The image's data.
 */
export function getImageData(x, y, width, height, ctx = targetContext) {
 ...
 * @param imgData The image's data.
 * @param x The x coordinate (based on the upper left corner).
 * @param y The y coordinate (based on the upper left corner).
 * @param ctx The canvas' context.
 */
export function putImageData(imgData, x, y, ctx = targetContext) {
 ...
 * @returns {*} The new image's data.
 */
export function fillImageData(imgData, value) {
